...
const App = () => {
  ...
  const agregarCliente = () => {
    ...
    const nuevoCliente = { id: contador, nombre: nombre, fechaReserva: fechaReserva, cantidadReserva: cantidadReserva };
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <Text style={styles.clienteNombre}>{item.cantidadReserva}</Text>
